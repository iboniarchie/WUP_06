...
The barplot is showing us that African Americans are more oppose to CAPPUN than    
other or WHITE.   
...
In table 1 that blacks at 34.62% are in favor of CAPPUN while other is at   
83.22%, and followed by white who are at 68.66%.      
...
The repaired fisher test shows that there is a signifacant difference between   
BLACK and WHITE. There is not a signifacant difference between WHIE and OTHER.  
other two races